...
class CategoryTrackingProductImport implements ToModel, WithHeadingRow, WithValidation
{
    ...
    public function model(array $row)
    {
        try {
            ...
            $code = trim($row['category_tracking_products_code'] ?? '');
            ...
            $attributes = [
                ...
                'name'                              => $row['category_tracking_products_name'],
            ...
            $existing = CategoryTrackingProduct::where('code', $code)->first();
    ...
    public function rules(): array
    {
        return [
            ...
            '*.category_tracking_products_code'     => 'required|max:200',
            '*.category_tracking_products_name'     => 'required|max:200',
